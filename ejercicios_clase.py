...
def ej2():
    ...
    # Suma
    print("El resultado de sumar", numero_3,"y", numero_4, "es", numero_3 + numero_4)
    # Resta
    print("El resultado de restar", numero_3,"y", numero_4, "es", numero_3 - numero_4)
    # División
    print("El resultado de dividir", numero_3,"y", numero_4, "es", numero_3 / numero_4)
    # Multiplicación
    print("El resultado de multiplicar", numero_3,"y", numero_4, "es", numero_3 * numero_4)
